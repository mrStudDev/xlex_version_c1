...
class AdvancedSearchForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['ementa', 'data_formatada_inicial', 'data_formatada_final','descricaoClasse', 'numeroProcesso',  'ministroRelator']
...
class SumulaSearchForm(forms.ModelForm):
    ...
    class Meta:
        model = SumulaModel
        fields = ['enunciado', 'sigla_tribunal','numero_sumula', 'nome_tribunal',  'tema_juridico']
